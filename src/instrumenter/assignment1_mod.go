...
func main() {
 InstrumenterInit()
	...
	vars32 := []interface{}{Logger,msg,buf,errRead,n,lAddr,errDial,conn,errWrite,incoming_msg,errR,errL,rAddr}
varsName32 := []string{"Logger","msg","buf","errRead","n","lAddr","errDial","conn","errWrite","incoming_msg","errR","errL","rAddr"}
